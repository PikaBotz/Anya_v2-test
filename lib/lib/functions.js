...
pika.body = (pika.mtype === 'conversation') 
  ...
  let quoted = (pika.quoted = pika.msg && pika.msg.contextInfo
	...
	*/
     ...
     **/
    pika.reply = (text, options = {}) => anyaV2.sendMessage(pika.chat, { text: text, mentions: options.mentions, contextInfo: { mentionedJid: options.mentions ? options.mentions : [], forwardingScore: 999, isForwarded: true } }, { quoted:pika })
